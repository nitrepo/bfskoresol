...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.key = "FbHMoLy9AF6jl9ZfId6Q2DhwF"
  config.twitter.secret = "WOqRZbFGluYo1AdFc2ei3K8I5MXVCNK6KmyNGg1qoPj0c6eJ5G"
  config.twitter.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = {:username => "screen_name"}

  config.facebook.key = "515834955184538"
  config.facebook.secret = "69371cedcb7d37bcc2bef0ff52cce863"
  ...
  config.user_config do |user|
    ...
    #
     ...
     user.remember_me_for = 100 # Two weeks in seconds
