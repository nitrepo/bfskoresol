Refinery::Videos.configure do |config|
    ...
    # config.dragonfly_secret = fb95356e15fe20ad2dc8aa56360a178dcd02ead8adbf9d58
    # If you decide to trust file extensions replace :ext below with :format
    # config.dragonfly_url_format = /system/videos/:job/:basename.:format
    # config.datastore_root_path = /home/ajay/scripts/Script_All_In_One/koresol/public/system/refinery/videos
